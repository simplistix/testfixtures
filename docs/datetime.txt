...
>>> from tests.sample1 import str_today_1
>>> with Replace('tests.sample1.date', mock_date()):
...    str_today_1()
...    str_today_1()
'2001-01-01'
'2001-01-02'
...
>>> with Replace('tests.sample1.date', mock_date(1978, 6, 13)):
...    str_today_1()
'1978-06-13'
...
>>> with Replace('tests.sample1.date', mock_date(None)) as d:
...    d.add(1978, 6, 13)
...    d.add(2009, 11, 12)
...    str_today_1()
...    str_today_1()
...
>>> with Replace('tests.sample1.date',
...
>>> with Replace('tests.sample1.date', mock_date(delta=2)) as d:
...    str_today_1()
...    d.set(1978,8,1)
...    str_today_1()
...    str_today_1()
...
>>> from tests.sample1 import str_now_1
>>> with Replace('tests.sample1.datetime', mock_datetime()):
...    str_now_1()
...    str_now_1()
'2001-01-01 00:00:00'
'2001-01-01 00:00:10'
...
>>> with Replace('tests.sample1.datetime',
...
>>> with Replace('tests.sample1.time', mock_time()):
...    str_time()
...    str_time()
'978307200.0'
'978307201.0'
...
>>> with Replace('tests.sample1.time',
...
>>> with Replace('tests.sample1.time', mock_time(None)) as t:
...
>>> with Replace('tests.sample1.time', mock_time(delta=2)) as d:
...    str_time()
...    d.set(1978, 8, 1)
...    str_time()
...    str_time()
...
>>> from tests.sample1 import str_now_2, str_today_2
>>> with Replacer() as replace:
...    today = replace('tests.sample1.today', mock_date().today)
...    now = replace('tests.sample1.now', mock_datetime().now)
...    str_today_2()
...    str_now_2()
'2001-01-01'
'2001-01-01 00:00:00'
